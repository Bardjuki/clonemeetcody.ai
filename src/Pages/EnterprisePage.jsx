		...
		<>
			...
			<Stack w={'98vw'} mb={'5em'} bgColor={'rgb(18,19,36)'}>
				...
				<Flex ml={5} mt={'5em'} direction={'row'} justifyContent={'center'}>
					...
					<Box w={'98vw'} h={'120vh'} borderRadius={'1em'} bgColor={'rgb(31,32,61)'}>
						<Flex
							direction={'column'}
							alignItems={'center'}
							justifyContent={'center'}
						>
							...
							<Text textAlign={'center'} fontSize={'1.25em'} mt={'3em'} w={'50em'}>
					...
					<Box mt={'5em'} w={'98vw'} h={'120vh'} borderRadius={'1em'} bgColor={'rgb(31,32,61)'}>
						<Flex
							direction={'column'}
							alignItems={'center'}
							justifyContent={'center'}
              ...
              Embark on Your AI Transformation Journey
							...
							<Text textAlign={'center'} mt={'3em'} w={'40em'}>
...
and discover how we can help your business thrive in the age of AI.
              ...
              <Box ml={5} display={'flex'} flexDir={'column'} gap={6}>
